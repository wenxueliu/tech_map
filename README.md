...
很多知道大体是什么，遇到问题能有基本的方向，但主要还是面向搜索引擎取解决。
平时读一些公众号文章、博客文章对很多技术都是浅尝辄止，缺乏全面系统的理解。
...
不了的，大部分我也解决不了。虽然技术广度比他们好的，但是这并不能体现在日常
的工作中。 所以，下定决心，用两年时间，解决如上两个问题。

期望结果：

对Java、Spring、Mybatis及常用日常组件有深入的理解，并形成体系，遇到问题
从原理进行分析、面向源码而不是搜索引擎解决问题
